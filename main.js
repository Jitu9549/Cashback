...
const mongo_url = "mongodb+srv://Jitu:jitu123@cluster0.94taf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
const botstart = async (ctx) =>{
    try{
        ...
        bot.telegram.sendMessage(ctx.from.id,text,{parse_mode:'Markdown',reply_markup:{keyboard:[[{text:"☎️ Share Contact",request_contact:true}]],resize_keyboard: true}})
    }catch(e){
        console.log(e)
senderr(e)
    }
